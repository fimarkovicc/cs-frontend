...
function ContentPlainText(props: ContentPlainTextProps) {
    ...
    return (
        <ContentPlainTextStyled>
            ...
            <p>Median cijene kvadrata u Hrvatskoj iznosi <em>{medianValue} €/m<sup>2</sup></em>. Što znači da polovica jedinica ima veću ili manju cijenu kvadrata od navedene.</p>
        </ContentPlainTextStyled>
    )
}
